...
from kunet_simple_module import KUnetSimpleModule
...
def main(args):
    ...
    model = KUnetSimpleModule(**vars(args))
...
def build_args():
    ...
    logdir = fetch_dir("log_path", path_config) / "kunet"

    parent_parser = ArgumentParser(add_help=False)

    parser = KUnetSimpleModule.add_model_specific_args(parent_parser)
