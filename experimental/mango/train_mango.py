...
from mango_module import MangoModule
...
def build_args():
    ...
    logdir = fetch_dir("log_path", path_config) / "mango"

    parent_parser = ArgumentParser(add_help=False)

    parser = MangoModule.add_model_specific_args(parent_parser)
