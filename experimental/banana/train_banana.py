...
from banana_module import BananaModule
...
def build_args():
    ...
    logdir = fetch_dir("log_path", path_config) / "banana"

    parent_parser = ArgumentParser(add_help=False)

    parser = BananaModule.add_model_specific_args(parent_parser)
