...
from allnet_module import AllnetModule
...
def build_args():
    ...
    logdir = fetch_dir("log_path", path_config) / "allnet"

    parent_parser = ArgumentParser(add_help=False)

    parser = AllnetModule.add_model_specific_args(parent_parser)
