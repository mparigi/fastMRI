...
from apple_module import AppleModule
...
def build_args():
    ...
    logdir = fetch_dir("log_path", path_config) / "apple"

    parent_parser = ArgumentParser(add_help=False)

    parser = AppleModule.add_model_specific_args(parent_parser)
