...
from iunet_module import IUnetModule
...
def build_args():
    ...
    logdir = fetch_dir("log_path", path_config) / "iunet"

    parent_parser = ArgumentParser(add_help=False)

    parser = IUnetModule.add_model_specific_args(parent_parser)
