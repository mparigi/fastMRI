...
class BananaModule(MriModule):
    """
    Banana training module.
    """
    ...
    def forward(self, image):
        ...
        out_ims = self.unet(image).squeeze(1)
        # print(f"out_ims = {out_ims.shape}")
        output = self.collapser(out_ims)
...
class DataTransform(object):
    ...
    def __call__(self, kspace, mask, target, attrs, fname, slice_num):
        ...
        # DO NOT apply Root-Sum-of-Squares if multicoil data
